...
public class StableObfuscationStyleTest extends RenamingClassNameTest {
  ...
  public String getModuleName() {
    return "org.gwtproject.resource.GssStableStyle";
  }
  ...
  public void testClassesRenaming() {
    ...
    assertEquals("org-gwtproject-resource-client-gss-TestResources-ClassNameAnnotation-renamed" +
            "-class", renamedClass);
    assertEquals("org-gwtproject-resource-client-gss-TestResources-ClassNameAnnotation" +
