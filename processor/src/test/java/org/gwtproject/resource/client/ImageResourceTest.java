...
public class ImageResourceTest extends GWTTestCase {
  ...
  public void testDedup() {
    ...
    Image i = new Image(a.getSafeUri().asString());
  ...
  public void testPreventInlining() {
    ...
    assertFalse(a.getSafeUri().asString().startsWith("data:"));
    assertFalse(b.getSafeUri().asString().startsWith("data:"));
  ...
  public void testSafeUri() {
    ...
    assertEquals(r.i64x64().getSafeUri().asString(), r.i64x64().getSafeUri().asString());
  }
}
